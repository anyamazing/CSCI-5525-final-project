# from https://github.com/mmrezaee/VRTM.git
import argparse
import os
...
'amazon_fashion':'fashion_'
}


def load_dataset(params,frequency_limit):
    #TODO: file prep as separate step
    frame = data.generate_dataframe()
    reviews = utils.get_product_reviews(frame, 'B009MA34NY')
    utils.reviews_to_file(reviews,'fashion_train.txt')
